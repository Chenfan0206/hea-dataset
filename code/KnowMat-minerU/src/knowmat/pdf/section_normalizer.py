...
# Keywords that indicate HEA and alloy context in this public release.
_MATERIALS_CONTEXT_KEYWORDS = re.compile(
    r"\b(?:alloy|alloys|metal|metals|phase|phases|"
    ...
    r"refractory|complex concentrated alloy|multi-principal|intermetallic|"
    r"magnetic|corrosion|oxidation|creep|fatigue|titanium|niobium|tantalum|tungsten|molybdenum|"
